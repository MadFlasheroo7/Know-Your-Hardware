...
@Composable
fun MeasurementCorrectionsLosSatsInfo(modifier: Modifier = Modifier) {
    Column(modifier = modifier.padding(top = 12.dp)) {
        Text(
            text = "Returns True if GNSS Chip supports line-of-sight satellite identification measurement corrections",
            style = TextStyle(
                fontSize = 18.sp,

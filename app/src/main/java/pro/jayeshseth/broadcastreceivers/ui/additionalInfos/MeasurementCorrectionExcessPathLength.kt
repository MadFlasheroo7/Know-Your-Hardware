...
@Composable
fun MeasurementCorrectionExcessPathLengthInfo(modifier: Modifier = Modifier) {
    Column(modifier = modifier.padding(top = 12.dp)) {
        Text(
            text = "Returns True if GNSS Chip supports per satellite excess-path-length measurement corrections",
            style = TextStyle(
                fontSize = 18.sp,
